...
//TLE
int L115_recur(char* s, char* t) {
    if (*t == '\0') return 1;
    if (*s == '\0') return 0;
    if (*s == *t) return L115_recur(s+1, t) + L115_recur(s+1, t+1);
    else return L115_recur(s+1, t);
}

int L115_unrecur(char* s, char* t) {
...
int L115_unrecur2(char* s, char* t) {
    int sn = s == NULL ? 0 : strlen(s);
    int tn = t == NULL ? 0 : strlen(t);
...
int L115_numDistinct(char* s, char* t) {
    return L115_unrecur2(s, t);
}
